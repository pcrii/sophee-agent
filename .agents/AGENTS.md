...
- **NO SLASH COMMANDS**: The user strongly dislikes Discord slash commands. Do not create new slash commands. Always prioritize giving the agent the ability to execute actions via function-calling tools, so the user can interact purely through natural language.
