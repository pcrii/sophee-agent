...
4. general_assistant: Use this for any other generic conversational queries, general questions, chitchat, Q&A, writing, coding, math, general assistance, searching the web, fact-checking, or if the user wants to scrape/check/read/review their suggestion box, notes, or ideas.
